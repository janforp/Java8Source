 ...
 *
 * Each proxy instance has an associated invocation handler.-- 每个代理实例都有一个关联的调用处理程序
 *
 ...
 * -- 在代理实例上调用方法时，该方法调用将被编码并分配到其调用处理程序的{@code invoke}方法。
 *
 * @author Peter Jones
 * @see Proxy
 * @since 1.3
...
public interface InvocationHandler {
     ...
     *
     * @param proxy the proxy instance that the method was invoked on -- 在其上调用方法的代理实例
